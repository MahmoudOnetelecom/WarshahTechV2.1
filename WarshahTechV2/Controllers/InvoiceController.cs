...
namespace WarshahTechV2.Controllers
{
    ...
    public class InvoiceController : ControllerBase
    {
        ...
        public IActionResult CreateInvoiceChecked(InvoiceDTO invoiceDTO)
        {
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    _NotificationService.SetNotification(Int32.Parse( invoice.CarOwnerID), "تم اصدار فاتورة جديدة ");
                    ...
                    _NotificationService.SetNotification(user.Id, messge2);
                    _uow.Save();
                    return Ok(invoice);
                }
                catch (Exception ex)
                    ...
                    if (repairorder.ReciptionOrderId != null)
                    {
                        ...
                        if (notificationActive != null)
                        {
                          ...
                          + "\n  " + InvoiceLink;
                            ...
                            _NotificationService.SetNotification(Int32.Parse(invoice.CarOwnerID), messge2);
                            ...
                            _NotificationService.SetNotification(user1.Id, messge);
                    ...
                    else
                    {
                        ...
                        if (notificationActive != null)
                        {
                          ...
                          + "\n  " + InvoiceLink;
                            ...
                            _NotificationService.SetNotification(userno.Id, messge3);
        ...
        public IActionResult CreateInspectionInvoice(int? ReportInspectionId)
        {
            if (ModelState.IsValid)
            {
                try
        ...
        {
            var invoices = _uow.InvoiceRepository.GetMany(t => t.WarshahId == id && t.InvoiceStatusId == 2).ToHashSet().OrderByDescending(a => a.Id);
        ...
        public IActionResult CreateInvoiceAfterPaid(int invoiceId)
        {
            if (ModelState.IsValid)
            {
                try
            ...
            if (ModelState.IsValid)
            {
                ...
                if (notificationActive != null)
                {
                  ...
                  + "\n  " + InvoiceLink;
                    ...
                    {
                        _NotificationService.SetNotification(Int32.Parse(invoicee.CarOwnerID), messge2);
                    }
                    ...
                    _NotificationService.SetNotification(user.Id, messge);
                }
            ...
            try
            {
                ...
                if (notificationActive != null)
                {
                  ...
                  + "\n  " + InvoiceLink;
                    ...
                    _NotificationService.SetNotification(Int32.Parse(inv.CarOwnerID), messge2);

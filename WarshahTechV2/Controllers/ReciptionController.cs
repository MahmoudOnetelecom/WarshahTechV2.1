    ...
    public class OrdersController : ControllerBase
    {
        ...
        public IActionResult AddReciptionOrder(ReciptionOrderDTO reciptionOrderDTO)
        {
            try
            {
                ...
                if (notificationActive != null)
                {
                    ...
                    _NotificationService.SetNotification(RepairOrder.TechId,messge3);
                    _NotificationService.SetNotification(reciptionOrderDTO.CarOwnerId, messge2);
        ...
        public IActionResult CreateRepairOrderFromInspection(int? ReportInspectionId)
        {
            try
            {
                ...
                if (notificationActive != null)
                {
                    ...
                    _NotificationService.SetNotification(RepairOrder.TechId, "تم تحويل طلب الفحص الى اصلاح وتحويله لك ");
                    _NotificationService.SetNotification(Report.CarOwnerId, "تم تحويل طلب الفحص الخاص بكم الى امر اصلاح ");
                }
        ...
        public IActionResult ChangeStatusRepairOrder(int? repairorderid, int? statusid)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    {
                        _NotificationService.SetNotification(order.TechId, "تم رفض امر اصلاح ");
                    }
        ...
        public IActionResult RejectOrder(ResonToRejectOrder resonToRejectOrder)
        {
            ...
            if (notificationActive != null)
            {
                ...
                _NotificationService.SetNotification(User, "تم رفض امر اصلاح !!");
            }

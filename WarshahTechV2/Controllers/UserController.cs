...
namespace Api.Controllers
{
    ...
    public class UserController : Controller
    {
                ...
                if (user.WarshahId != null)
                {
                    ...
                    if (notificationActive != null)
                    {
                        ...
                        if (employees.Count > 0)
                        {
                            ...
                            _NotificationService.SetNotification(user.Id, "سينتهى عقود بعض الموظفين خلال شهرين من فضلك قم بالمراجعة  ");
                        ...
                        {
                            _NotificationService.SetNotification(user.Id, "ستنتهى إقامة/الهوية لبعض الموظفين خلال شهرين من فضلك قم بالمراجعة  ");
                        }
                        ...
                        if (Passportemployees.Count > 0)
                        {
                            ...
                            _NotificationService.SetNotification(user.Id, "سينتهى صلاحية جواز السفر لبعض الموظفين خلال شهرين من فضلك قم بالمراجعة  ");
                        ...
                        if (Retirementemployees.Count > 0)
                        {
                            ...
                            _NotificationService.SetNotification(user.Id, " بعض الموظفين قاربوا من سن المعاش خلال شهرين من فضلك قم بالمراجعة  ");
                    ...
                    if (notificationrepairorder1 != null)
                    {
...

                        {
                            ...
                            foreach (var repairorder in repairorders1)
                            {
                                ...
                                {
                                    _NotificationService.SetNotification(user.Id, " دقيقة   " + time + "  يوجد امر إصلاح لم يتم  بدأ الإصلاح فيه منذ أكثر من   ");
                    ...
                    if (notificationrepairorder2 != null)
                    {
...

                        {
                            ...
                            foreach (var repairorder in repairorders1)
                            {
                                ...
                                if (dateTime > ExpectedTime)
                                {
                                    _NotificationService.SetNotification(user.Id, " دقيقة   " + time + "  يوجد امر إصلاح ينتظر تقرير الفنى منذ أكثر من   ");
                    ...
                    if (notificationrepairorder7 != null)
                    {
...

                        {
                            ...
                            foreach (var repairorder in repairorders1)
                            {
                                ...
                                if (dateTime > ExpectedTime)
                                {
                                    _NotificationService.SetNotification(user.Id, " دقيقة   " + time + "  يوجد امر إصلاح ينتظر موافقة العميل منذ أكثر من   ");
                    ...
                    if (notificationrepairorder3 != null)
                    {
...

                        {
                            ...
                            foreach (var repairorder in repairorders1)
                            {
                                ...
                                if (dateTime > ExpectedTime)
                                {
                                    _NotificationService.SetNotification(user.Id, " دقيقة   " + time + "  يوجد امر إصلاح ينتظر طلب قطع الغيار منذ أكثر من   ");
                    ...
                    if (notificationrepairorder4 != null)
                    {
...

                        {
                            ...
                            foreach (var repairorder in repairorders1)
                            {
                                ...
                                if (dateTime > ExpectedTime)
                                {
                                    _NotificationService.SetNotification(user.Id, " دقيقة   " + time + "  يوجد امر إصلاح ينتظر الفنى للتصليح منذ أكثر من   ");
                    ...
                    if (notificationrepairorder5 != null)
                    {
...

                        {
                            ...
                            foreach (var repairorder in repairorders1)
                            {
                                ...
                                if (dateTime > ExpectedTime)
                                {
                                    _NotificationService.SetNotification(user.Id, " دقيقة   " + time + "  يوجد امر إصلاح قيد الاصلاح و لم يتم إغلاقه منذ أكثر من   ");
       ...
       [ClaimRequirement(ClaimTypes.Role, RoleConstant.Admin)]
        ...
        public IActionResult RenewWarshahFromAdmin(RenewFromAdmin warshahDTO)
        {
        ...
        public IActionResult AddWarshahFromAdmin([FromForm] WarshahFromAdminDTO warshahDTO)
        {
        ...
        public IActionResult AddWarshah([FromForm] WarshahDTO warshahDTO)
        ...
        public IActionResult EditWarshah([FromForm] EditWarshahDTO warshahDTO)
        {
            if (ModelState.IsValid)
            {
                ...
                if (notificationActive != null)
                {
                    _NotificationService.SetNotification(User.Id, "تم تعديل بيانات الورشه ");
        ...
        public IActionResult EditUser(EditUserDTO user)
        {
            ...
            if (notificationActive != null)
            {
                ...
                _NotificationService.SetNotification(data.Id, "تم تعديل بياناتك الشخصية");
            }
            return Ok(data);
        }
                ...
                try
                {
                    ...
                    if (User != null)
                    {
                        ...
                        if (notificationActive != null)
                        {
                            ...
                            _NotificationService.SetNotification(User.Id, "تم تغيير كلمة المرور الخاصة بك ");
                        }
